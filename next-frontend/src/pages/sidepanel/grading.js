...
const Grading = () => {
  ...
  const [faqItems, setFaqItems] = useState([
    { question: "Why GemTCG?", answer: "We are committed to our customers and strive to ensure that everything we do is to benefit the collectors of the card world. We provide extra protection to your cards, cheaper prices, and fast turnaround times. If you're not satisfied with your experience with us, we will make amends to make things right.", open: false },
    { question: "What is the detailed process when grading through GemTCG?", answer: "At GemTCG, we offer lowered rates so you can save money on your grading costs, and the return shipping is free! After you ship your cards to us for grading, we send them to PSA within 2-5 days. After your grades are ready and returned back to us, we list them on the GemTCG marketplace. When they sell, you get all of the earnings with no fees attached. All orders shipped from us are packaged and shipped safe and securely to ensure an exceptional and seamless experience.", open: false },
    { question: "What happens if my cards don't sell / Can I have them shipped directly back to me?", answer: "If you're cards don't sell within 6 months, you can request to have them shipped back to you for free. If you wish to have them shipped back to you before 6 months, there will be an additional $5 charge per card.", open: false },
